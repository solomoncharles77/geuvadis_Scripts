...
write.table(genoSamps2, "genoFiles/matched_allSamps_Geno_Pheno.txt", row.names = F, quote = F, col.names = F)
write.table(mrnaSamps2, "exprFiles/matched_allSampsPheno.txt", row.names = F, quote = F, col.names = F)
